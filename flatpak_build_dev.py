...
if '--check' in sys.argv:
    ...
    cmd = 'flatpak-builder --force-clean --user --install builddir net.nogasgofast.adventure_wrench-devel.yml'
    print(cmd)
    subprocess.run(cmd.split(' '))
    
    print(cmd)
    cmd = 'flatpak run --command=flatpak-builder-lint org.flatpak.Builder manifest net.nogasgofast.adventure_wrench-devel.yml'
    subprocess.run(cmd.split(' '))
