...
class Ui_Vault(object):
    ...
    def retranslateUi(self, Vault):
        ...
        self.pushButton_acadamy.setText(QCoreApplication.translate("Vault", u"Acadamy", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.pushButton_the_shop.setText(QCoreApplication.translate("Vault", u"New Item (The shop)", None))
#if QT_CONFIG(tooltip)
